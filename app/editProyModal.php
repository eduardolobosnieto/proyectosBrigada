  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="editProy.php" method="post">
          ...
          <input type="hidden" id="rut" name="rut" value="<?= $rut; ?>"/>
            ...
            <input type="hidden" id="id_proyecto" name="id_proyecto" value="<?= $rowProy1['0'];?>">
          </div>

          <div class="mb-3">
            <label for="descripcion" class="form-label">Descripcion: </label>
            <textarea type="text" name="descripcion" id="descripcion" class="form-control" rows="3" required><?= $rowProy1['7'];?></textarea>
            <input type="hidden" id="descripcion_old"name="descripcion_old" value="<?php echo $rowProy1['7'];?>">
          </div>

          <div class="mb-3">
            <label for="nombre" class="form-label">Version del Proyecto: <?php echo $rowProy1['9'];?></label>
            <input type="hidden" id="version"name="version" value="<?php echo $rowProy1['9'];?>">
            <br/>
